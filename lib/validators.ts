...
export const FASTENER_OPTIONS: Array<{ label: string; sizeMm: number }> = [
  ...
  { label: '2"', sizeMm: 50.8 },
  { label: '2-1/4"', sizeMm: 57.15 },
  { label: '2-1/2"', sizeMm: 63.5 },
  { label: '2-3/4"', sizeMm: 69.85 },
  { label: '3"', sizeMm: 76.2 },
  { label: '3-1/4"', sizeMm: 82.55 },
  { label: '3-1/2"', sizeMm: 88.9 },
  { label: '3-3/4"', sizeMm: 95.25 },
  { label: '4"', sizeMm: 101.6 },
  { label: "M20", sizeMm: 20 },
  { label: "M24", sizeMm: 24 },
  { label: "M30", sizeMm: 30 },
  { label: "M36", sizeMm: 36 },
